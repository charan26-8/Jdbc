...
public class DBConnection {
	...
	Statement stmt=con.createStatement();//Step-4:The object of statement is responsible to execute queries with the database.  
	ResultSet rs=stmt.executeQuery("select * from employees") ; //step-5:This method returns the object of ResultSet that can be used to get all the records of a table.
	while(rs.next())  
